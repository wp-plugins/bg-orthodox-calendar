...
Плагин (http://bogaiskov.ru/plagin-orthodox-calendar/) позволяет вывести на экран окно с православным календарем на год. 
...
Запуск православного календаря на отдельной странице возможен также из адресной строки браузера. Например, чтобы вывести на экран календарь на год, необходимо указать в адресной строке: http://bogaiskov.ru/calendar/index.html?year=1958.
Чтобы вывести на экран календарь только на один месяц, используйте параметр month: http://bogaiskov.ru/calendar/index.html?year=1958&month=12
Существует также возможность вывести на экран календарь только на один день. Для этого используйте параметр date: http://bogaiskov.ru/calendar/index.html?year=1958&month=12&date=14
